...
Util.wechatInstalled = function (callback) {
    if ((typeof api === 'undefined' ? 'undefined' : (0, _typeof3.default)(api)) == 'object' && api.appInstalled) {
...
Util.jsonlog = function (content) {
    console.log((0, _stringify2.default)(content));
};
...
Util.sadd = function (key, val) {
    ...
    Util.setStorage(key, (0, _stringify2.default)(arr));
    return arr.length;
};
