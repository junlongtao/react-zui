...
!function (a) {
    ...
    var b = document,
        ...
        f = { type: 0, shade: !0, shadeClose: !0, fixed: !0, anim: !0 },
        g = {
        extend: function extend(a) {
            var b = JSON.parse((0, _stringify2.default)(f));
            for (var c in a) {
                b[c] = a[c];
            }return b;
        }, timer: {}, end: {}
    ...
    j.prototype.view = function () {
        ...
        var g = function () {
            var a = "object" == (0, _typeof3.default)(c.title);
        ...
        v: "1.7", index: h, open: function open(a) {
            var b = new j(a || {});
            return b.index;
...
}(window); /*! layer mobile-v1.7 弹层组件移动版 License LGPL    By 贤心 */