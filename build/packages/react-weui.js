(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('react'), require('date-fns/format'), require('date-fns/locale/zh_cn'), require('react-infinite-calendar'), require('react-infinite-calendar/styles.css'), require('qrcode-generator')) :
	typeof define === 'function' && define.amd ? define(['react', 'date-fns/format', 'date-fns/locale/zh_cn', 'react-infinite-calendar', 'react-infinite-calendar/styles.css', 'qrcode-generator'], factory) :
	(global.WeUI = factory(global.React,global.format,global.zh_cn,global.InfiniteCalendar,null,global.qrcode));
}(this, (function (React,format,zh_cn,InfiniteCalendar,reactInfiniteCalendar_styles_css,qrcode) { 'use strict';
