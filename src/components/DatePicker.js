...
export default class DatePicker extends React.Component{
	...
	render = () => { 
        ...
        const status = this.props.visible?'open':''
        return <div className={prefix+'-date-picker '+status}>
            <div className={prefix+"-date-picker-name"}>
                <Icon type="back" onClick={this.props.onBackClick}/>
                {this.props.name}
            </div>
            <div className={prefix+'-date-picker-content'}>
